...
type Puppies interface {
	...
	ScanBreed(context.Context, *Breed) (*PuppyList, error)
}

// =======================
// Puppies Protobuf Client
// =======================
...
func (c *puppiesProtobufClient) ScanBreed(ctx context.Context, in *Breed) (*PuppyList, error) {
	ctx = ctxsetters.WithPackageName(ctx, "com.ge.rpc")
	ctx = ctxsetters.WithServiceName(ctx, "Puppies")
	ctx = ctxsetters.WithMethodName(ctx, "ScanBreed")
	out := new(PuppyList)
...
func (c *puppiesJSONClient) ScanBreed(ctx context.Context, in *Breed) (*PuppyList, error) {
	ctx = ctxsetters.WithPackageName(ctx, "com.ge.rpc")
	ctx = ctxsetters.WithServiceName(ctx, "Puppies")
	ctx = ctxsetters.WithMethodName(ctx, "ScanBreed")
	out := new(PuppyList)
...
// ======================
// Puppies Server Handler
// ======================

type puppiesServer struct {
	Puppies
	hooks *twirp.ServerHooks
}

func NewPuppiesServer(svc Puppies, hooks *twirp.ServerHooks) TwirpServer {
	return &puppiesServer{
		Puppies: svc,
		hooks:   hooks,
	}
}
...
func (s *puppiesServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// PuppiesPathPrefix is used for all URL paths on a twirp Puppies server.
// Requests are always: POST PuppiesPathPrefix/method
// It can be used in an HTTP mux to route twirp requests along with non-twirp requests on other routes.
const PuppiesPathPrefix = "/twirp/com.ge.rpc.Puppies/"

func (s *puppiesServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "com.ge.rpc")
	ctx = ctxsetters.WithServiceName(ctx, "Puppies")
	...
	case "/twirp/com.ge.rpc.Puppies/UpdateAgeWeight":
		...
		return
	case "/twirp/com.ge.rpc.Puppies/ScanBreed":
		s.serveScanBreed(ctx, resp, req)
		return
	default:
...
func (s *puppiesServer) serveScanBreed(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveScanBreedJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveScanBreedProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *puppiesServer) serveScanBreedJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "ScanBreed")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	// Call service method
	var respContent *PuppyList
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.Puppies.ScanBreed(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *PuppyList and nil error while calling ScanBreed. nil responses are not supported"))
		return
	}
...
func (s *puppiesServer) serveScanBreedProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "ScanBreed")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *puppiesServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *puppiesServer) ProtocGenTwirpVersion() string {
	return "v5.8.0"
}

func (s *puppiesServer) PathPrefix() string {
	return PuppiesPathPrefix
}
